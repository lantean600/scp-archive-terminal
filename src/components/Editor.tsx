...
export function Editor() {
  const [draft, setDraft] = useState<Archive>(() => ({ ...initial, id: '', itemNumber: 'SCP-CN-', title: '', image: '' }))
  ...
  const preview = useMemo(() => ({ ...draft, image: image ? URL.createObjectURL(new Blob([])) : draft.image }), [draft, image])
